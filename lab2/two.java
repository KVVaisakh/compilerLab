...
public class two {
	...
	public two (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public two (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"0:10,6,0:22,4:2,0:2,3,4,0:3,3:2,0,3,5,3,2:10,0:3,4,0:3,1:26,0:6,1:26,0,4,0:" +
"3,7:2")[0];
...
"-1,1,2,3,4,-1,5,6,-1,1:2,-1:7,2,-1:2,8,-1:16,5,-1:3,7,-1:5");
